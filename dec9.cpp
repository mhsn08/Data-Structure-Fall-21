...
int BST::removing(int info,node *& temp)
{
    if(root == NULL)
    {
    ...
    if(root->info == info)
    {
        ...
        if(temp1->left == NULL)
        {
            ...
            prev_case = removing(temp->info , root->right);
        }
    }
    else{
        if(temp->info > info)
            ...
            if(temp->left != NULL)
            {
                if(temp->left->info == info)
                {
                    ...
                    else
                    {
                        ...
                        prev_case = removing(temp1->info , temp->left);
                ...
                if(temp->right->info == info)
                {
                    ...
                    else
                    {
                        ...
                        while(temp1->left != NULL)
                            temp1 = temp1->left;
                        int tempinfo = temp1->info;
                        prev_case = removing(temp1->info , temp->right);
...
void BST::inserting(int key , node *& temp)
{
    if(root == NULL)
    {
        root = new node;
    ...
    {   
        ...
        {
            cout << "Rotation at " << temp->info << endl;
            RotateRight(temp);
        }
        else
        {
...
void BST::post_order_traversal(node * temp)
{
    if(root == NULL)
    {
        cout << "[ ]" << endl;
...
void BST::pre_order_traversal(node * temp)
{
    if(root == NULL)
    {
        cout << "[ ]" << endl;
...
int BST::BalanceFactor(node * temp)
{
    if(temp == NULL)
        return 0;
    int l_subtree =  0;
...
void BST::P_BF_all(node * temp)
{
    ...
    if (temp == NULL)
        temp = root;
    int BF = BalanceFactor(temp);
    cout << "Balance Factor of " << temp->info << " : " <<  BF << endl;
    if(temp->left != NULL)
    {
        P_BF_all(temp->left);
    }
